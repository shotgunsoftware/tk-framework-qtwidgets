...
class Ui_VersionDetailsWidget(object):
    def setupUi(self, VersionDetailsWidget):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/tk-rv-shotgunreview/dock.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        icon.addPixmap(QtGui.QPixmap(":/tk-rv-shotgunreview/undock_hover.png"), QtGui.QIcon.Active, QtGui.QIcon.Off)
        icon.addPixmap(QtGui.QPixmap(":/tk-rv-shotgunreview/undock.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon.addPixmap(QtGui.QPixmap(":/tk-rv-shotgunreview/undock_hover.png"), QtGui.QIcon.Selected, QtGui.QIcon.Off)
        icon.addPixmap(QtGui.QPixmap(":/tk-rv-shotgunreview/undock_hover.png"), QtGui.QIcon.Selected, QtGui.QIcon.On)
        icon.addPixmap(QtGui.QPixmap(":/tk-rv-shotgunreview/dock_hover.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/tk-rv-shotgunreview/close.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        icon1.addPixmap(QtGui.QPixmap(":/tk-rv-shotgunreview/close_hover.png"), QtGui.QIcon.Active, QtGui.QIcon.Off)
        icon1.addPixmap(QtGui.QPixmap(":/tk-rv-shotgunreview/close.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon1.addPixmap(QtGui.QPixmap(":/tk-rv-shotgunreview/close_hover.png"), QtGui.QIcon.Selected, QtGui.QIcon.Off)
        icon1.addPixmap(QtGui.QPixmap(":/tk-rv-shotgunreview/close_hover.png"), QtGui.QIcon.Selected, QtGui.QIcon.On)
        icon1.addPixmap(QtGui.QPixmap(":/tk-rv-shotgunreview/close_hover.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/tk-rv-shotgunreview/navigate_out_hover.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        icon2.addPixmap(QtGui.QPixmap(":/tk-rv-shotgunreview/navigate_out.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        icon2.addPixmap(QtGui.QPixmap(":/tk-rv-shotgunreview/navigate_out_hover.png"), QtGui.QIcon.Selected, QtGui.QIcon.On)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/tk-rv-shotgunreview/tack_hover.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        icon3.addPixmap(QtGui.QPixmap(":/tk-rv-shotgunreview/tack_up.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        icon3.addPixmap(QtGui.QPixmap(":/tk-rv-shotgunreview/tack_hover.png"), QtGui.QIcon.Selected, QtGui.QIcon.On)
        ...
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap(":/tk-rv-shotgunreview/arrow.png"))
        ...
        self.label_2.setPixmap(QtGui.QPixmap(":/tk-rv-shotgunreview/arrow.png"))
        ...
        self.empty_label.setPixmap(QtGui.QPixmap(":/tk-rv-shotgunreview/panel_empty_background.png"))
