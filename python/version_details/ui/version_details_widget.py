...
class Ui_VersionDetailsWidget(object):
    def setupUi(self, VersionDetailsWidget):
        ...
        VersionDetailsWidget.setStyleSheet("")
        ...
        self.entity_tab_widget.setStyleSheet("QTabWidget::tab-bar { alignment: center }")
        ...
        self.note_stream_widget.setStyleSheet("* { background: transparent }")
