...
class Ui_ContextWidget(object):
    ...
    def retranslateUi(self, ContextWidget):
        ...
        self.task_display.setToolTip(QtGui.QApplication.translate("ContextWidget", "<html><head/><body><p>The task that the selected item will be associated with in Shotgun after publishing. It is recommended to always fill out the Task field when publishing. The menu button to the right will provide suggestions for Tasks to publish to including the Tasks assigned to you, recently used Tasks, and Tasks related to the entity Link populated in the field below. </p></body></html>", None, QtGui.QApplication.UnicodeUTF8))
        self.task_display.setText(QtGui.QApplication.translate("ContextWidget", "Loading...", None, QtGui.QApplication.UnicodeUTF8))
        self.task_search.setToolTip(QtGui.QApplication.translate("ContextWidget", "<html><head/><body><p>Type here to search for a Task to associate with the selected item. It is recommended that you always populate the Task field when publishing. Once a Task is found, the Link field will be populated below with the entity to which the Task belongs.</p></body></html>", None, QtGui.QApplication.UnicodeUTF8))
        self.task_menu_btn.setToolTip(QtGui.QApplication.translate("ContextWidget", "<html><head/><body><p>This menu shows Tasks related to any entity selected in the Link field. It also shows any Tasks assigned to you in Shotgun as well as Tasks you\'ve recently used.</p></body></html>", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.link_display.setToolTip(QtGui.QApplication.translate("ContextWidget", "<html><head/><body><p>The entity that the selected item will be associated with in Shotgun after publishing. By selecting a Task in the field above, the Link will automatically be populated. It is recommended that you always populate the Task field when publishing. The Task menu above will display any tasks associated with the entity populated in this field.</p></body></html>", None, QtGui.QApplication.UnicodeUTF8))
        self.link_display.setText(QtGui.QApplication.translate("ContextWidget", "Loading...", None, QtGui.QApplication.UnicodeUTF8))
        self.link_search.setToolTip(QtGui.QApplication.translate("ContextWidget", "<html><head/><body><p>Type here to search for an entity to associate with the selected item. It is recommended that you also always populate the Task field above when publishing. Once you find the entity in this field, check the Task menu above for related tasks to associate with the item.</p></body></html>", None, QtGui.QApplication.UnicodeUTF8))
