...
class ShotInfoWidget(QtGui.QWidget):
        ...
        def __init__(self, parent):
                ...
                self.setStyleSheet("QWidget { background: rgb(36,38,41); font-family: Proxima Nova; padding: 1px; padding-left: 4px; margin: 0px;} \
                    #thumbnail { background: #44aa33;}\
                    #shot_name { font-size: 15px; font-weight: normal; color: rgb(200,200,200)}\
                    #shot_version { font-size: 12px; }\
                    #shot_details { font-size: 12px; padding-left: 0px; }")
